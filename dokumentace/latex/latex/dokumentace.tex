...
\begin{figure}[h]
	...
	\caption{kleště\cite{servo-kleste}.} %% popisek obrázku, nezapomeň na citace!
...
\begin{figure}[h]
	...
	\caption{Serva\cite{serva}.} %% popisek obrázku, nezapomeň na citace!
...
\begin{figure}[h]
	...
	\caption{zapojení obvodu \cite{obvod}.} %% popisek obrázku, nezapomeň na citace!
...
\begin{figure}[h]
	...
	\centering
	\includegraphics[width=0.6\linewidth]{image/princip.jpg} 
	
	
	\caption{princip \cite{princip}.} %% popisek obrázku, nezapomeň na citace!
...
\begin{lstlisting}[style=Python, caption={Potřebné hodnoty}]
const int min= 2;  //
const int max = 160; //
